        ...
        <main className="relative z-10 max-w-[1000px] mx-auto px-8 py-16">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-sm max-w-[600px] mx-auto leading-relaxed" style={{ color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(26,26,26,0.6)' }}>
              A secure, temporary file sharing app. Drop files from any device, store them with auto-expiring encryption, and pick them up from anywhere.
            </p>
          </div>
          ...
          <section className="py-16 border-t" style={{ borderColor: classicBorder }}>
            ...
            <p className="text-sm max-w-[650px] mb-10" style={{ color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(26,26,26,0.6)' }}>
              A minimal set of tools for fast, secure file transfers. No bloat, no subscriptions — just what works.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ...
                ['AUTO-EXPIRY', 'Set files to auto-delete after 1h, 2h, 6h, 24h, or keep them forever. Expired drops are cleaned up automatically.'],
                ...
                ['SHARED WORKSPACES', 'Create workspaces, invite team members with a 6-character code, and collaborate on drops together in real time.'],
          ...
          <section className="py-16 border-t" style={{ borderColor: classicBorder }}>
            ...
            <div className="mb-12">
              ...
              {[
                ...
                ['2', 'DROP YOUR FILES', 'Drag files onto the page, click to browse, paste from clipboard, or type a text snippet. Set an expiry time or keep it forever.'],
                ...
                ['4', 'IT CLEANS UP', 'When the timer expires, files are automatically deleted from storage. Or keep them forever — your choice.'],
            ...
            <div>
              ...
              {[
                ...
                ['3', 'COLLABORATE ON DROPS', 'Any member can drop files, edit drops, and move drops between workspaces. Everything stays in sync.'],
                ['4', 'MANAGE YOUR TEAM', 'Owners can delete workspaces and remove members. Members can leave at any time. Workspace keys ensure only members can decrypt drops.'],
              ].map(([num, title, desc], i, arr) => (
                <div key={num} className="flex gap-6 py-6" style={{ borderBottom: i < arr.length - 1 ? `1px solid ${classicBorder}` : 'none' }}>
                  <div className="flex-shrink-0 w-10 h-10 border flex items-center justify-center font-mono text-sm" style={{ borderColor: classicBorder }}>{num}</div>
                  <div>
          ...
          <section className="py-16 border-t" style={{ borderColor: classicBorder }}>
            ...
            <p className="text-sm max-w-[650px] mb-10" style={{ color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(26,26,26,0.6)' }}>
              Files are encrypted at rest with AES-256-GCM. Metadata is stored in Firebase Firestore with strict access rules.
              Expired files are permanently deleted — no backups, no recovery.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {[
                ['ENCRYPTED AT REST', 'AES-256-GCM encryption on all stored files. Personal drops use individual keys, workspace drops use a shared workspace key.'],
                ['FIREBASE AUTH', 'Google and email/password authentication via Firebase. Tokens are validated server-side on every request.'],
                ['AUTO-DELETION', 'Expired drops are permanently removed from both storage and database. No hidden copies, no recovery window.'],
                ['WORKSPACE KEYS', 'Shared encryption keys for workspace collaboration. Only workspace members can encrypt and decrypt drops.'],
                ['ACCESS CONTROL', 'Only workspace owners can manage drops. Shared links are read-only — view and download, nothing else.'],
          ...
          <section className="py-16 text-center">
            ...
            <p className="text-sm mb-8" style={{ color: isDark ? 'rgba(255,255,255,0.6)' : 'rgba(26,26,26,0.6)' }}>Start sharing files in seconds. No signup forms, no downloads.</p>
      ...
      <main className="relative z-10 max-w-[1000px] mx-auto px-4 sm:px-8 lg:px-0 py-16">
        ...
        <section className="py-16 border-t font-[family-name:var(--font-raleway)]" style={{ borderColor: isDark ? '#333' : isMinimal ? '#b0b4a5' : '#e0e0e0' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-6">
            {[
              ...
              ['Auto-Expiry', 'Set files to auto-delete after 1h, 2h, 6h, 24h, or keep them forever. Expired drops are cleaned up automatically.', 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z'],
              ...
              ['Shared Workspaces', 'Create workspaces, invite team members with a 6-character code, and collaborate on drops together in real time.', 'M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z'],
        ...
        <section className="py-16 border-t font-[family-name:var(--font-raleway)]" style={{ borderColor: isDark ? '#333' : isMinimal ? '#b0b4a5' : '#e0e0e0' }}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ['Encrypted at Rest', 'AES-256-GCM encryption on all stored files. Personal drops use individual keys, workspace drops use a shared workspace key.', 'M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z'],
              ['Firebase Auth', 'Google and email/password authentication via Firebase. Tokens are validated server-side on every request.', 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'],
              ['Auto-Deletion', 'Expired drops are permanently removed from both storage and database. No hidden copies, no recovery window.', 'M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16'],
              ['Workspace Keys', 'Shared encryption keys for workspace collaboration. Only workspace members can encrypt and decrypt workspace drops.', 'M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z'],
              ['Access Control', 'Only workspace owners can manage workspace settings. Shared links are read-only — view and download, nothing else.', 'M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.88 9.88l-3.29-3.29m7.532 7.532l3.29 3.29M3 3l3.59 3.59m0 0A9.953 9.953 0 0112 5c4.478 0 8.268 2.943 9.543 7a10.025 10.025 0 01-4.132 5.411m0 0L21 21'],
        ...
        <section className="py-16 text-center font-[family-name:var(--font-raleway)]">
          ...
          <p className="text-[1rem] text-[#666] mb-8">Start sharing files in seconds. No signup forms, no downloads.</p>
