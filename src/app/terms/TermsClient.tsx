...
export default function TermsClient() {
    ...
    return (
      ...
      >
        <main className="relative z-10 mx-auto max-w-[800px] px-8 py-16">
          ...
          {/* Intro (sentence-case body; /privacy link) */}
          <p className="mb-12 text-sm leading-7" style={{ color: muted }}>
            These Terms of Service set the rules for using DropSync. By creating an account or using
            DropSync in any way, you agree to these Terms; if you do not accept them, do not use the
            service. DropSync is operated by Ahmed, based in Pakistan (referred to in these Terms as
            the &ldquo;Operator&rdquo;). These Terms explain your responsibilities when using DropSync
            and the limits of the service. For how we handle your personal data, see our{' '}
            <Link href="/privacy" className="underline" style={{ color: accentColor }}>
              Privacy Policy
            </Link>
            .
          </p>
          ...
          {/* 17. Contact — standalone (mailto + /privacy), rendered in BOTH layouts (invariant #6) */}
          <section className="mb-10">
            <h2 className="mb-4 font-mono text-sm uppercase tracking-wider">17. Contact</h2>
            <p className="mb-4 text-sm leading-7" style={{ color: muted }}>
  ...
  // ========================
  // EDITORIAL LAYOUT — byte-identical to the previous /terms page (only the PREPAINT <script>
