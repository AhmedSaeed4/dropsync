 ...
 * `TermsClient` (which branches the classic vs editorial layout from localStorage, gated behind a
...
// useEffect in `TermsClient` — KEEP IN SYNC. (Vars set on document.body.style, NEVER documentElement —
