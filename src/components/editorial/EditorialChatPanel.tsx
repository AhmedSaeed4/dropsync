  ...
  const handleSend = async () => {
    ...
    try {
      ...
      if (e instanceof AgentStoppedError) {
        ...
        // success path (handoffIdsRef stays empty, so the normal entrance
        // animation plays). Saves even after close/unmount (epoch already moved):
        // the write lands in the right conversation; state updates above are inert
